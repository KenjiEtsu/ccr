...
public class MainEventUtils {
    public static void sacrificar(Player player) {
        ...
        Component message = Component.text(0x25C6).color(TextColor.color(0xFF0027)).decorate(TextDecoration.BOLD)
            ...
            if (i == 31) {
                Bukkit.getScheduler().runTaskLater(Ccr.getPlugin(Ccr.class), () -> {
                    ...
                    for (Player player : Bukkit.getOnlinePlayers()) {
                        player.playSound(player.getLocation(), Sound.ENTITY_SKELETON_HORSE_DEATH, 1F, 0.5f);
                    }
